...
if __name__ == "__main__":
    innerV = float(input("Set inner frame velocity (rpm): "))
    outerV = float(input("Set outer frame velocity (rpm): "))
    maxSeg = int(float(input("Set simulation duration (hours): ")))
    startAnalysis = float(input("Set lower bound for analysis period (hours): "))
    endAnalysis = float(input("Set upper bound for analysis period (hours): "))
    ...
    analysis.createMagFig(magnitude, analysis.time, startAnalysis, endAnalysis, avgMagSeg, avgMagAnalysis, innerV, outerV, mode='show')
